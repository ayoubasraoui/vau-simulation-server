...
@Schema(name = "GenericErrorMessage-1", description = "[Reject Request]")
...
public class GenericErrorMessage1 {
  ...
  public GenericErrorMessage1 rejectReason(String rejectReason) {
  ...
  public GenericErrorMessage1 rejectReasonCode(String rejectReasonCode) {
