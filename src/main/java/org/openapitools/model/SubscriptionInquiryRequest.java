...
import org.openapitools.model.InquirySubscriptionAttributes;
...
@Schema(name = "SubscriptionInquiryRequest", description = "[Subscription Inquiry api request body]")
...
public class SubscriptionInquiryRequest {
  ...
  @Valid
  private List<@Valid InquirySubscriptionAttributes> subscriptions = new ArrayList<>();
   ...
   */
  public SubscriptionInquiryRequest(String merchantId, List<@Valid InquirySubscriptionAttributes> subscriptions, Integer acquirerSegmentId) {
    this.merchantId = merchantId;
    this.subscriptions = subscriptions;
    this.acquirerSegmentId = acquirerSegmentId;
  }

  public SubscriptionInquiryRequest merchantId(String merchantId) {
    this.merchantId = merchantId;
    return this;
  }
  ...
  public SubscriptionInquiryRequest subscriptions(List<@Valid InquirySubscriptionAttributes> subscriptions) {
    this.subscriptions = subscriptions;
    return this;
  }
  ...
  public List<@Valid InquirySubscriptionAttributes> getSubscriptions() {
    return subscriptions;
  }

  public void setSubscriptions(List<@Valid InquirySubscriptionAttributes> subscriptions) {
    this.subscriptions = subscriptions;
  }

  public SubscriptionInquiryRequest subMerchantName(String subMerchantName) {
  ...
  public SubscriptionInquiryRequest acquirerSegmentId(Integer acquirerSegmentId) {
    this.acquirerSegmentId = acquirerSegmentId;
    return this;
  }
