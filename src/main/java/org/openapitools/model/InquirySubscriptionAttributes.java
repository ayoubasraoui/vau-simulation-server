...
@Schema(name = "InquirySubscriptionAttributes", description = "[Inquiry Subscription attributes]")
...
public class InquirySubscriptionAttributes {
   ...
   */
  public InquirySubscriptionAttributes(String cardholderAccountNumber) {
    this.cardholderAccountNumber = cardholderAccountNumber;
  }

  public InquirySubscriptionAttributes cardholderAccountNumber(String cardholderAccountNumber) {
    this.cardholderAccountNumber = cardholderAccountNumber;
    return this;
  }
  ...
  public InquirySubscriptionAttributes acquirerOrMerchantProprietaryInfo(String acquirerOrMerchantProprietaryInfo) {
